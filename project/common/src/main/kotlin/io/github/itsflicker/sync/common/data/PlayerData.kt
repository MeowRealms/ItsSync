...
data class PlayerData(
    ...
    val advancements: JSONObject = JSONObject.of(),
    val stats: JSONObject = JSONObject.of(),
    val extraProperties: JSONObject = JSONObject.of()
) {
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + advancements.hashCode()
        result = 31 * result + stats.hashCode()
        result = 31 * result + extraProperties.hashCode()
        return result
    }
